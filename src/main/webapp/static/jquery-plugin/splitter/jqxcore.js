	...
	a
			.extend(
					a.jqx.utilities,
					{
						...
						resize : function(g, j, f) {
							if (this.resizeHandlers && f === true) {
								var d = -1;
								for ( var e = 0; e < this.resizeHandlers.length; e++) {
									if (g.id) {
										if (this.resizeHandlers[e].id == g.id) {
											d = e;
											break
										}
									} else {
										if (this.resizeHandlers[e].id == g[0].id) {
											d = e;
											break
										}
									}
								...
								if (d != -1) {
									this.resizeHandlers.splice(d, 1)
								}
								if (this.resizeHandlers.length == 0) {
									var b = a(window);
									if (b.off) {
										b.off("resize.jqx");
										b.off("orientationchange.jqx")
									} else {
										b.unbind("resize.jqx");
										b.unbind("orientationchange.jqx")
									}
							...
							if (!this.resizeHandlers) {
								...
								var c = function() {
									var k = function(o, m) {
										var n = o.widget.parents().length;
										var l = m.widget.parents().length;
										try {
											if (n < l) {
												return -1
											}
									...
									h.hiddenWidgets = new Array();
									h.resizeHandlers.sort(k);
									a
											.each(
													h.resizeHandlers,
													function(n, q) {
														...
														var o = p.jqxWidget.width;
														var l = p.jqxWidget.height;
														var m = false;
														if (o != null
																&& o
																		.toString()
									...
									if (h.hiddenWidgets.length > 0) {
										h.hiddenWidgets.sort(k);
										if (h.__resizeInterval) {
											clearInterval(h.__resizeInterval)
										}
										h.__resizeInterval = setInterval(
												function() {
													var l = false;
													var m = new Array();
													a
								...
								var b = a(window);
								if (b.on) {
									b.on("resize.jqx", function(k) {
										c()
									});
									b.on("orientationchange.jqx", function(k) {
										c()
									})
								} else {
									b.bind("resize.jqx", function(k) {
										c()
									});
									b.bind("orientationchange.jqx",
											function(k) {
												c()
											})
								}
					...
					a.jqx.mobile,
					{
						...
						touchScroll : function(d, y, g, D, b, k) {
							...
							var x = function(J) {
								...
								u = F;
								g(-n * 1, -l * 1, F, E, J);
								var G = b != null ? b[0].style.display != "none"
										: true;
								var K = k != null ? k[0].style.display != "none"
										: true;
								if (G || K) {
									if ((n !== 0 && G) || (l !== 0 && K)) {
										J.preventDefault();
